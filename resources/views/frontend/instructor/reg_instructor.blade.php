                        ...
                        <form method="post" action="{{route('instructor.register')}}" class="row">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('name') is-valid @enderror" id="name" type="text" name="name" placeholder="e.g. Alex">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" id="username" type="text" name="username" placeholder="e.g. Smith">
                                    <span class="la la-user input-icon"></span>
                                </div>
                            </div><!-- end input-box -->
                            <div class="input-box col-lg-12">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control @error('email') is-valid @enderror" id="email" type="email" name="email" placeholder="e.g. alexsmith@gmail.com">
                            ...
                            <div class="input-box col-lg-12">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" id="address" type="text" name="address" placeholder="e.g. 12345 Little Baker St, Melbourne">
