...
@section('home')
@section('title')
{{ $instructor->name }} | Mydemy - Learning Made Easy
@endsection
        ...
        <div class="breadcrumb-content">
            <div class="media media-card align-items-center pb-4">
                <div class="media-img media--img media-img-md rounded-full">
                    <img class="rounded-full" src="{{ (!empty($instructor->photo) && $instructor->photo != 'photo') ? url('upload/instructor_images/'.$instructor->photo) : url('upload/no_image.jpg')}}" alt="Student thumbnail image">
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 responsive-column-half">
                    <div class="counter-item">
                        ...
                        @php
                            $totalNumberOrder = App\Models\Order::where('instructor_id', $instructor->id)->count();
                            $totalNumberReview = App\Models\Review::where('instructor_id', $instructor->id)->count();
                        @endphp
                        <h4 class="counter__title counter text-color-2 fs-35">{{$totalNumberOrder}}</h4>
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="counter-item">
                        ...
                        <h4 class="counter__title counter text-color-3 fs-35">{{$totalNumberReview}}</h4>
    ...
    <div class="bg-gray py-5">
        <div class="container">
            <ul class="nav nav-tabs generic-tab justify-content-center" id="myTab" role="tablist">
                            {{-- app.mount('#app'); from @vite(['resources/js/app.js']) @ master.blade.php  --}}
                            
 
                            @auth
                
                            @if(Auth::user()->role =='admin' || Auth::user()->id === $instructor->id)
            
                            
                            @else
                            <button class="btn btn-danger lh-28 mr-2 mb-2 btn-lg" data-toggle="modal" data-target="#exampleModal">
                                <i class="la la-message mr-1"></i>Chat with {{$instructor->name}}
                            </button>
                            @endif
...
<section class="course-area section-padding">
    <div class="container">
        <div class="d-flex align-items-center justify-content-between pb-3">
            ...
            {{-- <span class="ribbon ribbon-lg">Total Number of Courses : {{ count($courses)}}</span> --}}
        </div>
        ...
        <div class="text-center pt-3">
            <div class="text-center pt-3">
                <nav aria-label="Page navigation example" class="pagination-box">
                        {{ $instructorCourses->links('vendor.pagination.custom') }}
                </nav>
                <p class="fs-14 pt-2">Total Number of Courses : {{count($instructorCourses)}}</p>
            </div>
        </div>
