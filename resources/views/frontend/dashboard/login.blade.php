...
@section('home')
@section('title')
Login Page | Ez Buy & Learn Online Course
@endsection
            ...
            <div class="col-lg-7 mx-auto">
                <div class="card card-item">
                  ...
                  {{--               <div class="d-flex align-items-center justify-content-between pb-4">
                                ...
                                <p  class="fs-14 pt-2 mt-3">Don't have an account? <a href="{{route('register')}}" class="btn btn-primary">Register <i class="la la-arrow-right icon ml-1"></i></a></p>
                            </div><!-- end btn-box -->
                        </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->
