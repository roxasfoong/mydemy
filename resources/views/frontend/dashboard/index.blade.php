...
@section('title')
Mydemy | Ez Buy & Learn Online Course
@endsection
@php

$id = Auth::user()->id;
$profileData = App\Models\User::find($id);
$totalNumberOrder = App\Models\Order::where('user_id',$id)->count();
$totalNumberCart = Gloudemans\Shoppingcart\Facades\Cart::count();
...
<div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between mb-5">
                <div class="media media-card align-items-center">
                    <div class="media-img media--img media-img-md rounded-full">              
                        <img class="rounded-full" src="{{(!empty($profileData->photo) && $profileData->photo !== 'photo') ? url('upload/user_images/'. $profileData->photo ) : url('upload/no_image.jpg')}}" alt="Student thumbnail image">
                    </div>
    ...
    {{--                         <div class="rating-wrap d-flex align-items-center pt-2">
            ...
            <div class="row">
                <a href="{{ route('my.course') }}" class="col-lg-4 responsive-column-half btn btn-transparent">
                    <div class="card card-item dashboard-info-card">
                        <div class="card-body d-flex align-items-center">
                            <div class="icon-element flex-shrink-0 bg-1 text-white">
                            <i class="la la-book larger-icon" style="font-size: 5rem;"></i>
 {{--                            <div class="icon-element flex-shrink-0 bg-1 text-white">
                            ...
                            <div class="pl-4">
                                ...
                                <h5 class="card-title pt-2 fs-26">{{$totalNumberOrder}}</h5>
                            </div>
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                </a><!-- end col-lg-4 -->
                ...
                <div class="col-lg-4 responsive-column-half">
                    <a href="{{route('user.profile')}}" class="card card-item dashboard-info-card btn btn-transparent">
                        <div class="card-body d-flex align-items-center">
                            <div class="icon-element flex-shrink-0 bg-2 text-white">
                                <i class="la la-user larger-icon" style="font-size: 5rem;"></i>
                     {{--            <svg class="svg-icon-color-white" width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                            ...
                            <div class="pl-4">
                                <p class="card-text fs-18">My Profile</p>
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div  class="card card-item dashboard-info-card">
                        <a href="{{ route('user.wishlist')}}" class="card-body d-flex align-items-center btn btn-transparent">
                            <div class="icon-element flex-shrink-0 bg-3 text-white">
                                <i class="la la-heart-o larger-icon" style="font-size: 5rem;"></i>
                           {{--      <svg class="svg-icon-color-white" width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                                        <g>
                                            <g>
                                                <g>
                            ...
                            <div class="pl-4">
                                ...
                                <h5 class="card-title pt-2 fs-26" id="indexWishQty">0</h5>
                            </div>
                        </a><!-- end card-body -->
                    </div><!-- end card -->
                </div><!-- end col-lg-4 -->
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item dashboard-info-card">
                        ...
                        <a href="{{ route('instructor.node.chat') }}" class="card-body d-flex align-items-center btn btn-transparent">
                        @else
                        <a href="{{ route('live.Node.chat') }}" class="card-body d-flex align-items-center btn btn-transparent">
                        @endif
                        
                            <div class="icon-element flex-shrink-0 bg-4 text-white">
                                <i class="la la-comment larger-icon" style="font-size: 5rem;"></i>
{{--                                 <svg class="svg-icon-color-white" width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 490.667 490.667" xml:space="preserve">
                                        <g>
                                            <g>
                                                <path d="M245.333,85.333c-41.173,0-74.667,33.493-S74.667,74.667s33.493,74.667,74.667,74.667S320,201.173,320,160
                            ...
                            <div class="pl-4">
                                <p class="card-text fs-18">Live Chat</p>
                                <h5 class="card-title pt-2 fs-26" id="indexMessQty">0</h5>
                            </div>
                        </a><!-- end card-body -->
                    </div><!-- end card -->
                </div><!-- end col-lg-4 -->
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item dashboard-info-card">
                        <a href="{{ route('mycart') }}" class="card-body d-flex align-items-center btn btn-transparent">
                            <div class="icon-element flex-shrink-0 bg-5 text-white">
                                <i class="la la-shopping-bag larger-icon" style="font-size: 5rem;"></i>
                                {{-- <svg class="svg-icon-color-white" width="40" version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                                        <g>
                                            <g>
                                                <g>
                            ...
                            <div class="pl-4">
                                <p class="card-text fs-18">My Cart</p>
                                <h5 class="card-title pt-2 fs-26">{{$totalNumberCart}}</h5>
                            </div>
                        </a><!-- end card-body -->
                    </div><!-- end card -->
                </div><!-- end col-lg-4 -->
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="card card-item dashboard-info-card">
                        <a href="{{ route('user.change.password') }}" class="card-body d-flex align-items-center btn btn-transparent">
                            <div class="icon-element flex-shrink-0 bg-6 text-white">
                                <i class="la la-lock larger-icon" style="font-size: 5rem;"></i>
                            ...
                            <div class="pl-4">
                                <p class="card-text fs-18">Change Password</p>
