...
@section('home')
@section('title')
Register Page | Ez Buy & Learn Online Course
@endsection
            ...
            <div class="col-lg-7 mx-auto">
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('user.register') }}" class="pt-4" enctype="multipart/form-data">
                             @csrf
                           
                            <div class="input-box">
                                <label class="label-text">Name</label>
                                <div class="form-group">
                                    <input class="form-control form--control" id="name" type="name" name="name" placeholder="Your Name">
...
{{--                                 <div class="custom-control custom-checkbox mb-2 fs-15">
                                ...
                                <p class="fs-14 pt-2 mt-3">Already have an account? <a href="{{route('login')}}" class="btn btn-primary">Log in <i class="la la-arrow-right icon ml-1"></i></a></p>
                            </div><!-- end btn-box -->
                        </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->
