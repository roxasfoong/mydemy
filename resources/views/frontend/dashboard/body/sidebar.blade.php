...
@endphp
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@fortawesome/line-awesome/css/line-awesome.min.css">
        ...
        <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
            <li>
                <a href="{{ route('index') }}" style="font-size:1.2rem;">
                    <i class="la la-home mr-2 fs-1"></i> Home
                </a>
            </li>
