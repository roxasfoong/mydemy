...
<section class="course-area pb-120px">
    <div class="container">
        ...
        <ul class="nav nav-tabs generic-tab justify-content-center pb-4" id="myTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" id="{{ $category->id }}-tab" data-toggle="tab" href="#business{{ $category->id }}" role="tab" aria-controls="business{{ $category->id }}" aria-selected="true">{{ $category->category_name }}</a>
            </li>
            @endforeach
    ...
    <div class="card-content-wrapper bg-gray pt-50px pb-120px">
        <div class="container">
            <div class="tab-content" id="myTabContent">
                            ...
                            <div class="card card-item card-preview" data-tooltip-content="#tooltip_{{ $course->id }}">
                                <div class="card-image">
                                    ...
                                    <div class="course-badge-labels">
                                        ...
                                        <div class="course-badge white">New</div>
                                        @else
                                        <div class="course-badge yellow">{{ round($discount) }}%</div>
                                        @endif
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        @if ($course->discount_price == NULL || $course->discount_price == '-1')
                                        ...
                                        <div id="{{ $course->id }}" onclick="addToWishList(this.id)" class="icon-element icon-element-sm shadow-sm cursor-pointer" title="Add to Wishlist"><i class="la la-heart-o"></i></div>
                                    </div>
                                </div><!-- end card-body -->
                            </div><!-- end card -->
                        </div><!-- end col-lg-4 -->
                ...
                @php
                $catwiseCourse = App\Models\Course::where('main_category_id',$category->id)->where('status',1)->orderBy('id','DESC')->get();
                @endphp

                <div class="tab-pane fade" id="business{{ $category->id }}" role="tabpanel" aria-labelledby="{{ $category->id }}-tab">
                <div class="row">
                    ...
                    <h5 class="text-danger"> No Course Availabl1e For This Category</h5>
            ...
            <div class="more-btn-box mt-4 text-center">
                <a href="{{route('show.all.category')}}" class="btn theme-btn">Browse all Courses <i class="la la-arrow-right icon ml-1"></i></a>
