    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-3">
                <div class="category-btn-box text-right">
                    <a href="{{route('show.all.category')}}" class="btn theme-btn">All Categories <i class="la la-arrow-right icon ml-1"></i></a>
        ...
        <div class="category-wrapper mt-30px">
            <div class="row">
                ...
                @php
              $course = App\Models\Course::where('main_category_id',$cat->id)->get();     
                @endphp
