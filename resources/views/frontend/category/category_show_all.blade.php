...
@section('home')
@section('title')
All Category | Ez Buy & Learn Online Course
@endsection
    ...
    <div class="container">
        <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
            <div class="section-heading">
                <h2 class="section__title text-white">Catgory : All</h2>
            </div>
            <ul class="generic-list-item generic-list-item-white generic-list-item-arrow d-flex flex-wrap align-items-center">
                <li><a href="{{route('index')}}">Home</a></li>
                <li><b>All Category</b></li>
            </ul> 
    ...
    <div class="container">
        <div class="filter-bar mb-4">
            <div class="filter-bar-inner d-flex flex-wrap align-items-center justify-content-between">
                <p class="fs-14">Found <span class="text-black">{{$totalCourses}}</span> courses available.</p>
            ...
            <div class="col-lg-8">
                ...
                <div class="text-center pt-3">
                    <div class="text-center pt-3">
                        ...
                        <p class="fs-14 pt-2">Total Number of Courses : {{$totalCourses}}</p>
                    </div>
