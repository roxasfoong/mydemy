...
@section('home')
@section('title')
{{ $subcategory->subcategory_name }} | Ez Buy & Learn Online Course
@endsection
    ...
    <div class="container">
        <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
            <div class="section-heading">
                <h2 class="section__title text-white">SubCatgory : {{$subcategory->subcategory_name}}</h2>
            </div>
            <ul class="generic-list-item generic-list-item-white generic-list-item-arrow d-flex flex-wrap align-items-center">
                <li><a href="{{route('index')}}">Home</a></li>
                <li><b>{{$subcategory->subcategory_name}}</b></li>
            </ul>
            ...
            <div class="col-lg-4">
                <div class="sidebar mb-5">
                  ...
                  {{--   <div class="card card-item">
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="card-title fs-18 pb-2">Course SubCategories</h3>
                            <div class="divider"><span></span></div>
                            <ul class="generic-list-item">
                                @foreach ($subcategories as $cat)
                                 <li><a href="{{ url('subcategory/'.$cat->id.'/'.$cat->subcategory_slug) }}">{{ $cat->subcategory_name }}</a></li> 
                                @endforeach 
                    ...
                    @foreach($subcategories as $findCategory)
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="card-title fs-18 pb-2">{{$findCategory->subcategory_name}}</h3>
                            <div class="divider"><span></span></div>
                            <ul class="generic-list-item">
                    @foreach($allCourses as $findCourse)
                                @if($findCourse->subcategory_id == $findCategory->id)
