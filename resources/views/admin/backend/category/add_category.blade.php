...
<div class="page-content">
    ...
    <div class="card-body p-4">
        ...
        <form name="myForm" id="myForm" action="{{route('store.category')}}" method="post" class="row g-3" enctype="multipart/form-data">
            @csrf
    ...
    $(document).ready(function () {
        $('#myForm').validate({
            rules: {
                ...
                image: { // Use the name attribute of the file input
                    required: true,
