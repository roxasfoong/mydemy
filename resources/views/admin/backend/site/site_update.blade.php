        ...
        <div class="card-body p-4">
            ...
            <form id="myForm" action="{{ route('update.site') }}" method="post" class="row g-3" enctype="multipart/form-data">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="phone" class="form-control" id="input1" value=""  >
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="address" class="form-control" id="input1" value=""  >
                </div>
                <div class="form-group col-md-6">
                    <label for="input1" class="form-label">	facebook</label>
                    <input type="text" name="facebook" class="form-control" id="input1" value=""  >
                </div>
                <div class="form-group col-md-6">
                    <label for="input1" class="form-label">	twitter</label>
                    <input type="text" name="twitter" class="form-control" id="input1" value=""  >
                </div>
                <div class="form-group col-md-6">
                    <label for="input1" class="form-label">	copyright</label>
                    <input type="text" name="copyright" class="form-control" id="input1" value=""  >
                </div>
                ...
                <div class="col-md-6"> 
                    <img id="showImage" src="" alt="Admin" class="rounded-circle p-1 bg-primary" width="80"> 
